...
with beam.Pipeline('DirectRunner', options = opts) as p:
    ...
    query_results = p | 'Read from BigQuery for txt' >> beam.io.Read(beam.io.BigQuerySource(query = 'SELECT * FROM fec_modeled.Candidates limit 100'))
    ...
    qualified_table_name = PROJECT_ID + ':fec_modeled.Candidates_Beam'
